...
{
	// focal_x and focal_y are image width and height in pixels
	float3 t = transformPoint4x3(mean, viewmatrix);

	// restrict to screen space
	...
	// recover sigma matrix from the compact form
	glm::mat3 sigma = glm::mat3(
		cov3D[0], cov3D[1], cov3D[2],
		cov3D[1], cov3D[3], cov3D[4],
		cov3D[2], cov3D[4], cov3D[5]);

	// recover the view matrix by transpose
	glm::mat3 W = glm::mat3(
	...
	glm::mat3 T = W * sigma * glm::transpose(W);
	glm::mat3 cov = J * T * glm::transpose(J);
